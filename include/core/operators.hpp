...
namespace numcpp {
    ...
    inline MaskedArray operator&(const MaskedArray& lhs, const MaskedArray& rhs) {
        return binary_opr_broadcast(lhs, rhs, std::bit_and());
    }
    inline MaskedArray operator&(const MaskedArray& lhs, const bool value) {
        return binary_opr_element_wise(lhs, value, std::bit_and());
    }
    inline MaskedArray operator&(const bool value, const MaskedArray& rhs) { return rhs & value; }
    ...
    template <typename V>
    array<V> operator+(const MaskedArray& lhs, const V& value) {
        return binary_opr_element_wise(lhs, value, std::plus());
    }
    template <typename V>
    ...
    inline MaskedArray& operator+=(MaskedArray& lhs, const MaskedArray& rhs) { return lhs |= rhs; }
    ...
    inline MaskedArray operator~(const MaskedArray& arr) { return unary_opr_element_wise(arr, std::bit_not()); }
    inline MaskedArray operator|(const bool value, const MaskedArray& rhs) { return rhs | value; }
    inline MaskedArray operator^(const bool value, const MaskedArray& rhs) { return rhs ^ value; }
    inline MaskedArray operator==(const bool value, const MaskedArray& rhs) { return rhs == value; }
    inline MaskedArray operator!=(const bool value, const MaskedArray& rhs) { return rhs != value; }
